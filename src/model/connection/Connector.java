...
/*
 * Essa classe é a classe de conexão com o banco de dados e ela só pode ser
 * instanciada uma única vez (Singleton)
 * 
 * @author Ingrid Lyra
 * 
...
public class Connector {
	 ...
	 * 
	 * @return instancia - uma instância, nula ou do objeto connector, que é a
	 *         conexão com banco
	 */
	...
	public Connector() throws SQLException {
		try {
			...
			this.con = DriverManager.getConnection("jdbc:oracle:thin:@" + oracleServer + ":1521:" + databaseName,
	 ...
	 * 
	 * @return Boolean - se foi realizado o update ou não, se não houver nenhum
	 *         erro, retorna true
	 */
